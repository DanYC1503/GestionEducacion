...
a persistence unit "GestionEducationPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "GestionEducation/pom.xml":
...
artifact ("GestionEducation.war") is already built. You can build
